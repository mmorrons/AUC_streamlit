        ...
        for col in range(2):
            ...
            with cols[col]:
                ...
                fig.add_trace(go.Scatter(
                    ...
                    hovertemplate='Time: %{x}<br>{select_data_type}: %{y}<extra></extra>'
                ))
                ...
                fig.add_trace(go.Scatter(
                    ...
                    line=dict(color='red'),
                    showlegend=False,
                    hovertemplate='Start: Time: %{x}<br>{select_data_type}: %{y}<extra></extra>'
                ))
                fig.add_trace(go.Scatter(
                    x=[end_time, end_time],
                    y=[baseline, end_y],
                    ...
                    line=dict(color='red'),
                    showlegend=False,
                    hovertemplate='End: Time: %{x}<br>{select_data_type}: %{y}<extra></extra>'
                ))
